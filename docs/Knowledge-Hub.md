...
## Fast Confirmed Rooms VS Non-fast Confirmed Rooms <a name="confirm-type"></a>
      ...
      ## Guest Names <a name="guest-name"></a>
      ...
      + For English name, it must be the same as guest's English name on passport.
      ...
      + Code="321" - Required field missing: Illegal name
      + Code="100029" - Illegal name
